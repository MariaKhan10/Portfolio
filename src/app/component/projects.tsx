            ...
            >
              <div className="flex relative">
                <Image
                  alt="gallery"
                  className="absolute inset-0 w-full h-full object-cover object-center"
                  src={require("../../../public/pictures/encryption.webp")}
                />
                <div className="px-8 py-3 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100 transition-opacity duration-300">
                  <h2 className="tracking-widest text-sm title-font font-medium text-blue-500 mb-1">
                  ...
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-3">
                    A Secure Data Encryption and Decryption App built with (Python + Streamlit)
                  </h1>
                  <p className="leading-relaxed line-clamp-2 text-gray-700">
                    Built a Data Encryption Application using Python, Streamlit, and UV.
                  </p>
                  <Link
                    target="_blank"
                    href={"https://mariakhan10-project-05-main-3jr35x.streamlit.app/"}
                  >
                    <p className="leading-relaxed text-blue-500 font-bold hover:underline">
                      View Live
                    </p>
